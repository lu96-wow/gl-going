#lang racket/base
;; =========================================================
;; 03-glsl-types/02-types.rkt —— 第二步：GLSL 的类型 + 构造器
;; 运行：racket 03-glsl-types/02-types.rkt    点 X = 退出
;; =========================================================
...
(define-values (frame canvas)
  (make-window #:title "03-02 类型与构造器" #:width 400 #:height 400 #:draw draw))
