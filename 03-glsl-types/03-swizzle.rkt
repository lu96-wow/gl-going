#lang racket/base
;; =========================================================
;; 03-glsl-types/03-swizzle.rkt —— 第三步：swizzle 重排分量
;; 运行：racket 03-glsl-types/03-swizzle.rkt    点 X = 退出
;; =========================================================
...
(define-values (frame canvas)
  (make-window #:title "03-03 swizzle" #:width 400 #:height 400 #:draw draw))
