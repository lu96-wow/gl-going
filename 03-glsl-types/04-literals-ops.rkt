#lang racket/base
;; =========================================================
;; 03-glsl-types/04-literals-ops.rkt —— 第四步：字面量纪律 + 运算符
;; 运行：racket 03-glsl-types/04-literals-ops.rkt    点 X = 退出
;; =========================================================
...
;;   语句版的 if/for 等控制流留到 04 课——本课只用表达式。
;;
;; 本步视觉（一次把上面全展示）：
...
(define-values (frame canvas)
  (make-window #:title "03-04 字面量与运算符" #:width 400 #:height 400 #:draw draw))
