#lang racket/base
;; =========================================================
;; 03-glsl-types/06-shadertoy.rkt —— 第六步：综合，把本课全串起来
;; 运行：racket 03-glsl-types/06-shadertoy.rkt    点 X = 退出
;; =========================================================
...
;;
;; 现在你能把一段 GLSL 当"像素的数学公式"来读了。下一课(04)给它加控制流
;; （if/for/函数），06 课再加 uTime 让 ring 真正动起来。
;; =========================================================
...
(define-values (frame canvas)
  (make-window #:title "03-06 着色玩具（综合）" #:width 400 #:height 400 #:draw draw))
