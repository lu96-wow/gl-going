#lang racket/base
;; =========================================================
;; 10-lighting/03-phong.rkt —— 第三步：Blinn-Phong 三件套
;; 运行：racket 10-lighting/03-phong.rkt    点 X = 退出
;; =========================================================
...
(define-values (frame canvas)
  (make-window #:title "10-03 Blinn-Phong 光照" #:width 600 #:height 600 #:draw draw))
