#lang racket/base
;; =========================================================
;; 02-triangle/02-vbo.rkt —— 第二步：把顶点数据搬进显存（VBO）
;; 运行：racket glsl/02-triangle/02-vbo.rkt
;; =========================================================
;; 上一步：读懂了着色器文本。本步准备数据——先把顶点搬上 GPU。
...
(define-values (frame canvas)
  (make-window #:title "02-02 VBO" #:width 400 #:height 300 #:draw draw))
