#lang racket/base
;; =========================================================
;; 18-model/06-demo.rkt —— 第六步：综合演示（相机环绕 + 暂停 + 切换）
;; 运行：racket glsl/18-model/06-demo.rkt
...
(define-values (frame canvas)
  (make-window #:title "18-06 模型导入（综合）" #:width 800 #:height 600
