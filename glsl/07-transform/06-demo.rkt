#lang racket/base
;; =========================================================
;; 07-transform/06-demo.rkt —— 第六步：综合，像素世界里的旋转与公转
;; 运行：racket glsl/07-transform/06-demo.rkt    点 X = 退出
;; =========================================================
...
(define-values (frame canvas)
  (make-window #:title "07-06 旋转与公转（综合）" #:width 800 #:height 600 #:draw draw))
