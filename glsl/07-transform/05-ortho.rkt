#lang racket/base
;; =========================================================
;; 07-transform/05-ortho.rkt —— 第五步：正交投影（像素世界 → NDC）
;; 运行：racket glsl/07-transform/05-ortho.rkt    点 X = 退出
;; =========================================================
...
(define-values (frame canvas)
  (make-window #:title "07-05 正交投影（像素世界）" #:width 400 #:height 400 #:draw draw))
