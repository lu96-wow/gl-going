#lang racket/base
;; =========================================================
;; 13-instancing/02-animate.rkt —— 第二步：每实例多属性 + 起浪
;; 运行：racket glsl/13-instancing/02-animate.rkt    点 X = 退出
;; =========================================================
...
(define-values (frame canvas)
  (make-window #:title "13-02 每实例属性（起浪）" #:width 800 #:height 600 #:draw draw))
