#lang racket/base
;; =========================================================
;; 13-instancing/01-instances.rkt —— 第一步：实例化基础
;; 运行：racket glsl/13-instancing/01-instances.rkt    点 X = 退出
;; =========================================================
...
(define-values (frame canvas)
  (make-window #:title "13-01 实例化基础（100 个立方体）" #:width 800 #:height 600 #:draw draw))
