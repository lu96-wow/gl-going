#lang racket/base
;; =========================================================
;; 08-3d-depth/03-perspective.rkt —— 第三步：透视投影（近大远小）
;; 运行：racket glsl/08-3d-depth/03-perspective.rkt    点 X = 退出
;; =========================================================
...
(define-values (frame canvas)
  (make-window #:title "08-03 透视投影（近大远小）" #:width 400 #:height 400 #:draw draw))
