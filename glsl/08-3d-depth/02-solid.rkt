#lang racket/base
;; =========================================================
;; 08-3d-depth/02-solid.rkt —— 第二步：实心面 + 深度缓冲
;; 运行：racket glsl/08-3d-depth/02-solid.rkt    点 X = 退出
;; =========================================================
...
;;   同一个角在不同面上颜色不一样 → 必须拆开存（每面 4 个）。11 课光照
...
(define-values (frame canvas)
  (make-window #:title "08-02 实心立方体（深度）" #:width 400 #:height 400 #:draw draw))
