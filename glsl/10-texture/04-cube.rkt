#lang racket/base
;; =========================================================
;; 10-texture/04-cube.rkt —— 第四步：立方体贴图 + 收 load-tex 进 lib
;; 运行：racket glsl/10-texture/04-cube.rkt    点 X = 退出
;; =========================================================
...
;;   每面 4 个顶点（因为每面的 uv 排列不同，角不能共享，和 08 课"每面颜色
...
(define-values (frame canvas)
  (make-window #:title "10-04 立方体贴图" #:width 600 #:height 600 #:draw draw))
