#lang racket/base
;; =========================================================
;; 11-lighting/01-normal.rkt —— 第一步：法线（表面朝向）
;; 运行：racket glsl/11-lighting/01-normal.rkt    点 X = 退出
;; =========================================================
...
;;   因为每个面法线不同，角不能共享 → 6 面 × 4 顶点 = 24 顶点（和 08 课
;;   "每面颜色不同要拆面"同理）。
;;
...
(define-values (frame canvas)
  (make-window #:title "11-01 法线可视化" #:width 600 #:height 600 #:draw draw))
