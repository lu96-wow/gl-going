#lang racket/base
;; =========================================================
;; 11-lighting/02-lambert.rkt —— 第二步：Lambert 余弦定律（漫反射）
;; 运行：racket glsl/11-lighting/02-lambert.rkt    点 X = 退出
;; =========================================================
...
(define-values (frame canvas)
  (make-window #:title "11-02 Lambert 余弦定律" #:width 600 #:height 600 #:draw draw))
