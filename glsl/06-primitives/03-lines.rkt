#lang racket/base
;; =========================================================
;; 06-primitives/03-lines.rkt —— 第三步：线图元（GL_LINES / LINE_STRIP / LINE_LOOP）
;; 运行：racket glsl/06-primitives/03-lines.rkt    点 X = 退出
;; =========================================================
...
(define-values (frame canvas)
  (make-window #:title "06-03 线" #:width 400 #:height 400 #:draw draw))
