#lang racket/base
;; =========================================================
;; 06-primitives/06-demo.rkt —— 第六步：综合，一个窗口看全图元 + 索引
;; 运行：racket glsl/06-primitives/06-demo.rkt    点 X = 退出
;; =========================================================
...
(define-values (frame canvas)
  (make-window #:title "06-06 图元与索引（综合）" #:width 600 #:height 600 #:draw draw))
