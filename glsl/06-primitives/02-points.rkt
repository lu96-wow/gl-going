#lang racket/base
;; =========================================================
;; 06-primitives/02-points.rkt —— 第二步：图元类型 + 点（GL_POINTS）
;; 运行：racket glsl/06-primitives/02-points.rkt    点 X = 退出
;; =========================================================
...
(define-values (frame canvas)
  (make-window #:title "06-02 点" #:width 400 #:height 400 #:draw draw))
