#lang racket/base
;; =========================================================
;; 06-primitives/01-color.rkt —— 第一步：顶点颜色（aColor）
;; 运行：racket glsl/06-primitives/01-color.rkt    点 X = 退出
;; =========================================================
...
;;
;; ★复习与推广（04 课讲过双属性，这里只是分量数不同）：
;;   04 课的第二个属性 aUV 是 vec2（2 个 float）。本步 aColor 是 vec3
...
(define-values (frame canvas)
  (make-window #:title "06-01 顶点颜色" #:width 400 #:height 400 #:draw draw))
