#lang racket/base
;; =========================================================
;; 05-primitives/05-ebo.rkt —— 第五步：EBO 索引缓冲
;; 运行：racket 05-primitives/05-ebo.rkt    点 X = 退出
;; =========================================================
...
;;
;; ★问题（03 课埋的伏笔）：四边形 = 2 个三角形，用 GL_TRIANGLES 要 6 个顶点，
...
(define-values (frame canvas)
  (make-window #:title "05-05 EBO 索引缓冲" #:width 400 #:height 400 #:draw draw))
