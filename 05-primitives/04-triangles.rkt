#lang racket/base
;; =========================================================
;; 05-primitives/04-triangles.rkt —— 第四步：三角形图元 + 省顶点
;; 运行：racket 05-primitives/04-triangles.rkt    点 X = 退出
;; =========================================================
...
;;   四边形 = 2 个三角形。用 GL_TRIANGLES 要 6 个顶点（03 课那个四边形就是，
...
(define-values (frame canvas)
  (make-window #:title "05-04 三角形条带" #:width 400 #:height 400 #:draw draw))
