#lang racket/base
;; =========================================================
;; 06-transform/01-translate.rkt —— 第一步：uniform mat4 + 平移矩阵
;; 运行：racket 06-transform/01-translate.rkt    点 X = 退出
;; =========================================================
;; 前五课顶点直接写 NDC 坐标。本步开始用**矩阵**移动它，这是 3D 的第一块地基。
;;
;; 本步新增（2 组）：
...
(define-values (frame canvas)
  (make-window #:title "06-01 平移矩阵" #:width 400 #:height 400 #:draw draw))
